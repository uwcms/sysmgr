...
You may find it at https://gitlab.cern.ch/WisconsinCMS/IPMI/sysmgr
...
```sh
git remote set-url origin ssh://git@gitlab.cern.ch:7999/WisconsinCMS/IPMI/sysmgr.git
```
...
```sh
git remote set-url origin https://gitlab.cern.ch/WisconsinCMS/IPMI/sysmgr.git
```
